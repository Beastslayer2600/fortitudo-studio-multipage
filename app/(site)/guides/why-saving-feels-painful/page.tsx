...
export default function SavingPainfulGuide() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-5">
          <p>
            The brain's reward system releases dopamine — the neurotransmitter associated with pleasure — in ways that reinforce behaviors leading to satisfying outcomes. The critical point is this:{' '}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-5">
          <p>
            Delay discounting is the rate at which your brain reduces the perceived value of a future reward. Here's what it looks like in practice:
          </p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-5">
          <p>
            The famous Stanford Marshmallow Test gave children one marshmallow, with the promise of two if they waited fifteen minutes. Children who waited showed better life outcomes decades later — higher test scores, better stress management, stronger relationships.
          </p>
          <p>
            For decades this was read as proof that willpower is the key variable. <span className="text-white">Discipline wins.</span>
          </p>
          <p>
            But more recent research complicated this. Children from unstable home environments — where adults regularly broke promises — were far less likely to wait. Not because they lacked willpower. Because waiting for a reward that might not come is irrational when your environment is unreliable.{' '}
      ...
      content: (
        <div className="space-y-5">
          ...
          <ul className="space-y-5 mt-4">
            {[
              ['Social comparison is at its peak', 'Your early twenties are when identity is most fluid. Social media shows you everyone\'s highlight reel — the cars, the travel, the restaurants. Your limbic system registers this as a threat to status and pushes you to spend to keep up.'],
              ...
              ['Retirement feels impossibly abstract', 'At 23, 65 is not a real place. It\'s a concept. Your brain cannot generate genuine emotional urgency around something that far away — which means saving for it produces almost no dopamine motivation.'],
    ...
    },
    {
      ...
      content: (
        <div className="space-y-5">
          <p>Understanding the neuroscience is only useful if it leads to behavior change. Here's what the research and practice actually support.</p>
          <div className="space-y-4 mt-6">
            {[
              {
                title: 'Automate everything',
                body: 'The most powerful intervention is removing the decision entirely. A debit order that moves money into your TFSA or RA before you see it means your limbic system never gets the chance to claim it. You cannot spend money you never consciously had.',
                tag: 'Highest impact',
              },
              {
                title: 'Make saving feel immediate',
                body: "Attach your saving to a concrete, near-term image. Not 'retirement' — something specific. A property deposit. Financial independence at 45. The more vivid and tangible the future reward, the more your brain can generate motivation around it.",
                tag: 'Mindset',
              },
              {
                title: 'Add friction to spending',
                body: 'Remove saved card details from online stores. Put a 24-hour rule on purchases above a certain amount. These small friction points give your prefrontal cortex the time it needs to override the limbic response.',
                tag: 'Environment design',
              },
              {
                title: 'Track your net worth monthly',
                body: 'Watching a number grow creates a feedback loop. You start to feel the reward of saving in the present, not just the abstract future. This is how you begin to rewire the dopamine response — by making the invisible visible.',
                tag: 'Behavioral',
              },
              {
                title: 'Understand your money scripts',
                body: "The beliefs you inherited about money — that it's scarce, that wealthy people are lucky or corrupt, that you should spend it before it's gone — run beneath every financial decision you make. Identifying them is the beginning of changing them.",
                tag: 'Psychology',
              },
              {
                title: 'Work with a financial adviser',
                body: 'Not because you can\'t figure it out alone. Because accountability creates social stakes — and social stakes are a limbic motivator. Knowing someone is tracking your progress engages the same social reward circuitry that makes peer pressure powerful, and redirects it toward your benefit.',
                tag: 'Accountability',
              },
            ].map((item) => (
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-zinc-300">
      ...
      <section className="max-w-3xl mx-auto px-6 py-14">
        ...
        >
          You know you should be saving. You know compound interest works. You know skipping the takeout and investing instead is the smarter move. And yet — the takeout wins. The purchase happens. The investment gets pushed to next month.
          <br /><br />
      ...
      <section className="max-w-3xl mx-auto px-6 pb-16">
        ...
        >
          ...
          <p className="text-zinc-300 leading-relaxed mb-4">
            Saving feels painful because your brain is ancient and your financial system is modern. The mismatch between the two is not your fault — but navigating it is your responsibility.
          </p>
          <p className="text-zinc-400 leading-relaxed">
            The people who build wealth aren't more disciplined. They've designed their environment so that the right decision is also the path of least resistance. They've automated, simplified, and removed the moment of choice where the limbic system wins.
          </p>
        </motion.div>
      </section>
